...
document.getElementById("resume-button-1").onclick = (event) => {
    ...
    window.open("https://drive.google.com/file/d/1PQh57Wvtd8YMOVAa-tO0NhP3x_mTlCYq/view?usp=drive_link", "_blank");
};
...
emailjs.init('zdyzgO002BDua7W_e'); 
...
function sendEmail(event) {
    ...
    if (name && email && message) {
        ...
        emailjs.send('service_1da5meh', 'template_lodznji', templateParams)
            .then(response => {
